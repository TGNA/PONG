...
int id_win, id_n_moviments, id_tecla, id_cont, id_busties;
...
int inicialitza_joc(void){
  ...
  *p_cont = -1;
  ...
  id_busties = ini_mem(sizeof(int[numPaletes]));
...
void * moure_pilota(void * cap){
  int f_h, c_h, i, paleta;
  char rh,rv,rd, mis[4], direccio;
...
int main(int n_args, const char *ll_args[]){
  ...
  *p_n_moviments = numMovimentsMax;
  ...
  char str_n_fil[10], str_n_col[10], str_l_pal[10], str_ipo_pf[10], str_ipo_pc[10], str_po_pf[10], str_v_pal[10], str_id_win[20], str_id_n_moviments[20], str_id_tecla[20], str_id_cont[20], str_index[2], str_id_sem_pantalla[20], str_id_sem_vglobals[20], str_retard[20], str_id_busties[20], str_numPaletes[10];
  ...
  sprintf(str_id_sem_pantalla, "%i", id_sem_pantalla);
  sprintf(str_id_sem_vglobals, "%i", id_sem_vglobals);
  sprintf(str_retard, "%i", retard);
  sprintf(str_id_busties, "%i", id_busties);
  sprintf(str_numPaletes, "%i", numPaletes);
  ...
  for ( i = 0; i < numPaletes; i++){
    ...
    if (tpid[n] == (pid_t) 0){   /* branca del fill */
      ...
      execlp("./pal_ord4", "pal_ord4", str_n_fil, str_n_col, str_l_pal, str_ipo_pf, str_ipo_pc, str_po_pf, str_v_pal, str_id_win, str_id_n_moviments, str_id_tecla, str_id_cont, str_index, str_id_sem_pantalla, str_id_sem_vglobals, str_retard, str_id_busties, str_numPaletes, (char *)0);
